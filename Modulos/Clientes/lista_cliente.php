            ...
            <td>
            	...
            	<table class="table table-bordered">
                  <tr class="well">
                    ...
                    <td width="42%"><strong>Nombre y Apellidos</strong></td>
                    <td width="20%"><div align="right"><strong>Cupo Disponible</strong></div></td>
                    <td width="20%"><strong><center>Registro de Abonos</center></strong></td>
                  </tr>
                  	<?php 
				  		if(!empty($_POST['buscar'])){ 
							$buscar=limpiar($_POST['buscar']);
							$pa=mysql_query("SELECT * FROM cliente, persona, username WHERE 
							username.usu=persona.doc and username.tipo='cliente' and 
							(persona.doc='$buscar' or persona.nom LIKE '%$buscar%' or persona.ape LIKE '%$buscar%') group by persona.nom");
                   ...
                   <tr>
                    ...
                    <td>
                    	<?php 
							$sql2=mysql_query("SELECT * FROM cliente WHERE doc='".$row['doc']."'");
						...
						?>
                    	<div align="right"> $ <?php echo formato($cupo); ?></div>
                    </td>
                    <td>
                    	<center>
                        	<a href="../venta/abonos.php?doc=<?php echo $url; ?>" class="btn btn-mini">
                            	<i class="icon-list"></i> <strong>Registrar Abonos</strong>
                        	</a>
                        </center>
                    </td>
                  </tr>
