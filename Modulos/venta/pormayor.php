...
<html lang="es">
  ...
  <body>
	                ...
	                <div class="span8">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <a href="pormayor.php?del=<?php echo $row['id']; ?>" class="btn btn-mini" title="Remover de la Lista de Compra">
    ...
    <div id="contado" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    	<form name="contado" action="pro_contado_pormayor.php" method="get">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
