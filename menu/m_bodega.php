        ...
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
              ...
              <li><a href="estado.php" style="color:#FFF">Estado de Inventario</a></li>
              <li><a href="actualizar.php" style="color:#FFF">Actualizar Inventario</a></li>
              <li><a href="compra.php" style="color:#FFF">Realizar Compras</a></li>
            </ul>
